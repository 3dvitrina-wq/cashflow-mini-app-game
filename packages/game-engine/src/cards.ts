...
export const CARDS: CardDefinition[] = [
...

  {
    id: 'opp-storage',
    type: 'opportunity',
    title: 'TENANTED STORAGE POD',
    text: 'The owner is selling a storage pod with a tenant already inside. No hidden gold: it nets $250 each month after upkeep.',
    hostCue: 'The treasure is an ordinary tenant who pays on time.',
    rarity: 'common',
    weight: 3,
...

  {
    ...
    text: 'A local courier is selling a delivery route with repeat clients. Buy it for $2K and it adds $980 each month.',
...

  {
    ...
    text: 'A laundromat with 12 machines and loyal night customers. Ownership nets $600 a month; leasing the equipment nets $200.',
...

  {
    ...
    text: 'Three vending machines in a college dorm. All three net $170 a month after refills; one machine adds $120.',
...

  {
    ...
    text: 'A coffee franchise in a business district. Full ownership nets $950 a month; running one counter nets $250 and adds stress.',
...

  {
    ...
    text: '$400 a month for email and scheduling. Active income +$200, stress -2; the first delegation test arrives in 3–5 months.',
    ...
    choices: [
      { id: 'hire', label: 'Hire ($400/mo)', effects: [
        ...
        { type: 'stress.delta', amount: -2 },
        { type: 'income.add', amount: 200 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-va', outcomeCardId: 'followup-assistant-double-booking', requiredStaffId: 'virtual_assistant', minDelay: 3, maxDelay: 5 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },

  {
    ...
    type: 'staff',
    title: 'BOOKKEEPER',
    text: '$300 a month for daily bookkeeping. Stress -1, local-business costs can fall; old payments are reviewed in 3–5 months.',
    ...
    choices: [
      { id: 'hire', label: 'Hire ($300/mo)', effects: [
        ...
        { type: 'expense.add', amount: 300 },
        { type: 'stress.delta', amount: -1 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-bookkeeper', outcomeCardId: 'followup-bookkeeper-refund', requiredStaffId: 'bookkeeper', minDelay: 3, maxDelay: 5 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },

  {
    ...
    text: '$500 a month for content and distribution. Passive income +$300, reputation +1; the first campaign report lands in 3–7 months.',
    ...
    choices: [
      { id: 'hire', label: 'Hire ($500/mo)', effects: [
        ...
        { type: 'passive.add', amount: 300 },
        { type: 'reputation.delta', amount: 1 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-social', outcomeCardId: 'followup-social-viral-post', requiredStaffId: 'social_manager', minDelay: 3, maxDelay: 7 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },

  {
    ...
    text: '$800 a month to ship the backlog. Active income +$600, stress -1; their first solo release arrives in 3–5 months.',
    ...
    choices: [
      { id: 'hire', label: 'Hire ($800/mo)', effects: [
        ...
        { type: 'income.add', amount: 600 },
        { type: 'stress.delta', amount: -1 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-coder', outcomeCardId: 'followup-junior-friday-deploy', requiredStaffId: 'junior_dev', minDelay: 3, maxDelay: 5 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },

  {
    ...
    text: '$150 a month for weekly cleaning and stress -1. A client visit will test whether anyone notices in 4–6 months.',
    ...
    choices: [
      { id: 'hire', label: 'Hire ($150/mo)', effects: [
        ...
        { type: 'expense.add', amount: 150 },
        { type: 'stress.delta', amount: -1 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-cleaner', outcomeCardId: 'followup-cleaner-client-visit', requiredStaffId: 'cleaner', minDelay: 4, maxDelay: 6 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },

  {
    ...
    type: 'staff',
    title: 'TRADING BOT',
    text: '$600 a month for a trading bot. It adds $400 passive income and stress +1; its first audited night arrives in 3–4 months.',
    ...
    choices: [
      { id: 'hire', label: 'Subscribe ($600/mo)', effects: [
        ...
        { type: 'passive.add', amount: 400 },
        { type: 'stress.delta', amount: 1 },
        { type: 'outcome.schedule', payload: { sourceCardId: 'staff-trader', outcomeCardId: 'followup-trading-bot-night', requiredStaffId: 'trading_bot', minDelay: 3, maxDelay: 4 } },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
    ],
  },
...

  {
    ...
    choices: [
      { id: 'launch', label: 'Launch ($500 setup)', effects: [
        { type: 'cash.delta', amount: -500 },
        { type: 'asset.add', amount: 500, payload: { kind: 'content_channel', name: 'Content Channel', tags: ['digital', 'content'], synergyKeys: ['content_creation'], incomePerRound: 200, upkeepPerRound: 0, value: 500, slotsUsed: 1 } },
        { type: 'expense.tag', value: 'content_creation' },
        { type: 'reputation.delta', amount: 1 },
      ] },
      { id: 'skip', label: 'Skip', effects: [] },
...

  {
    ...
    choices: [
      ...
      ], hint: '$500 income and $200 upkeep each month' },
...
export function getWeightedCardIds(): { id: string; weight: number }[] {
  return CARDS
    .map((c) => ({ id: c.id, weight: c.weight ?? 1 }))
