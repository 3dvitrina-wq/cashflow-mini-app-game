...
export const CommandSchema = z.discriminatedUnion('type', [
  ...
  z.object({
    ...
    askingPrice: z.number().int().min(0).max(1_000_000),
  }),
  z.object({ type: z.literal('accept_personal_card'), playerId: PlayerIdSchema, offerId: z.string() }),
  z.object({ type: z.literal('decline_personal_card'), playerId: PlayerIdSchema, offerId: z.string() }),
...
export const MatchStateSchema = z.object({
  ...
  personalCardPurchasedIds: z.record(z.string(), CardIdSchema.nullable()).optional(),
  personalCardIntentQueues: z.record(z.string(), z.array(z.object({
    cardId: CardIdSchema,
  ...
  globalCardId: CardIdSchema.nullable().optional(),
