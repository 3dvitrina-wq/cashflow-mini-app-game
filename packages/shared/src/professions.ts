...
// Starting liquidity is intentionally narrow by tier and expenses are calibrated
// so a passive 15-round run ends in roughly the same score. High earners reach
// expensive decisions faster, while low earners have a much smaller freedom gap.
// ─────────────────────────────────────────────────────────────────────────────
