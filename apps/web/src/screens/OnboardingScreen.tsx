...
const ru = {
  ...
  goalTitle: 'Цель',
  goalText: 'Главная цель: пассивный доход покрывает все ежемесячные обязательства, а кредит игрового банка равен нулю. Если никто не успел — решает Freedom Score.',
  ...
  moneyTitle: 'Деньги',
  moneyText: 'Cash нужен для решений сейчас. Большая зарплата означает и большую нагрузку: сравнивай не оклад, а путь до свободы.',
  dealsTitle: 'Сделки',
...
const en = {
  ...
  goalTitle: 'Goal',
  goalText: 'Primary goal: recurring non-work income covers every monthly obligation and game-bank debt is zero. If nobody gets there, Freedom Score decides.',
  ...
  moneyTitle: 'Money',
  moneyText: 'Cash pays for choices now. A high salary comes with a heavier burden, so compare distance to freedom, not the paycheck.',
  dealsTitle: 'Deals',
