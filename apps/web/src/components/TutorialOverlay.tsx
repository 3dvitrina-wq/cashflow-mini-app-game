...
const BASIC_STEPS: Step[] = [
  ...
  },
  {
    ...
    title: 'Месяц, рынок и ваш таймер',
    copy: 'Здесь время на выбор и номер раунда. Перед новой личной картой общий рынок появится в центре на две секунды и один раз повлияет на весь стол.',
  },
  {
    id: 'players',
  ...
  },
  {
    ...
    title: 'Большая зарплата — не победа',
    copy: 'ДЕНЬГИ — запас сейчас. ПОТОК — итог месяца после зарплаты, налогов, жизни и долгов. У богатой профессии больше поток, но гораздо тяжелее обязательства.',
  },
  {
    id: 'freedom',
    selector: '[data-tour="freedom"]',
    title: 'Вот ваша настоящая цель',
    copy: 'Нажмите эту шкалу. Для свободы пассивные доходы должны покрыть все ежемесячные обязательства, а кредит игрового банка — быть погашен. Стартовые долги можно закрывать: тогда цель уменьшается.',
    interactive: true,
  },
  {
    id: 'actions',
    ...
    copy: 'Эта кнопка всегда открывает одно меню действий. Когда рынок активен, она становится зелёным магазином — но банк, персонал, питомцы и работа остаются внутри.',
  },
  {
    id: 'reactions',
